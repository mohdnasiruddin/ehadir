        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Laporan e-Kehadiran KVDSAZI (<?php echo $dahUbah;?>)</h6>
            </div>
            <div class="card-body">
              <div class="">
                ...
                <table class="table table-bordered" id="dataTable" cellspacing="0">
                  ...
                  <?php 
                      ...
                      $thn = $_SESSION['tahun'];
                      $cls = $_SESSION['kelas'];
                      $dateDicari = date("Y-m-d");
                      

                      $data3 = mysqli_query($connection,"SELECT * FROM studinfo WHERE stud_year='$thn' AND stud_class='$cls' AND stud_status='0'");
//                      $data3 = mysqli_query($connection,"SELECT  studinfo.*, hadirinfo.* from studinfo INNER JOIN hadirinfo INNER JOIN userinfo ON studinfo.stud_id = hadirinfo.stud_id WHERE studinfo.stud_year = userinfo.user_year AND studinfo.stud_class = userinfo.user_class ");
                   ...
                   ?>
                    ...
                    <tr>
                      ...
                      <?php 
                        ...
                        $data4 = mysqli_query($connection, "SELECT * FROM hadirinfo WHERE stud_ic = '$idPel' AND hadir_date='$dateDicari' ");
              ...
              ?></tbody>
                  ...
                  <a target="_blank" href="report.php?thn=<?php echo $thn ;?>&kls=<?php echo $cls ;?>&tarikh=<?php echo $dateDicari;?>" class="btn btn-primary btn-icon-split">
